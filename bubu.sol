...
contract BUBU is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x6a88b79eE11e6d61b01Ef2309B9b0E668085c268);
    address payable private _twdmkt = payable(0x6a88b79eE11e6d61b01Ef2309B9b0E668085c268);
    
    string private constant _name = "BUBU";
    string private constant _symbol = "BUBU";
    ...
    constructor () {
        ...
        _isExcludedFromFee[_twddev] = true;
