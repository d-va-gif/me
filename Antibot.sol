...
contract VelaCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAa8374C21A2d780Fc8dB01d5bD5B3b9574e7E345);
    address payable public Wallet_Dev = payable(0xAa8374C21A2d780Fc8dB01d5bD5B3b9574e7E345);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =900000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Vela COIN"; 
    string private constant _symbol = unicode"VLC"; 
    ...
    constructor  () {
        _owner =0xbDE7dFa07EedAC48dc7c8721D83bBa6Ea78f5c31;
